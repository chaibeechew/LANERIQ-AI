...
export const PRODUCTION_COGNITIVE_GATE_VERSION="1.3.0";
...
function optional(enabled,verified){return enabled!==true||verified===true;}
...
export function evaluateProductionCognitiveGate(input={}){
  ...
  const checks=Object.freeze({
    ...
    independentIntelligenceAttestationVerified:input.independentIntelligenceAttestationVerified===true,
    featureJudgesVerified:input.featureJudgesVerified===true,
    cognitiveSelfHealVerified:input.cognitiveSelfHealVerified===true,
    allProductCognitiveCoverageVerified:input.allProductCognitiveCoverageVerified===true,
    allSystemSurfaceCoverageVerified:input.allSystemSurfaceCoverageVerified===true,
    constitutionalExecutionTokenVerified:input.constitutionalExecutionTokenVerified===true,
    constitutionalToolExecutionVerified:input.constitutionalToolExecutionVerified===true,
    constitutionalRedTeamVerified:input.constitutionalRedTeamVerified===true,
    realWorldExecutionBoundaryVerified:input.realWorldExecutionBoundaryVerified===true,
    assuranceControlPlaneVerified:input.assuranceControlPlaneVerified===true,
    evidenceAssuranceMeshVerified:input.evidenceAssuranceMeshVerified===true,
    capabilityRiskGraphVerified:input.capabilityRiskGraphVerified===true,
    supplyChainAttestationVerified:input.supplyChainAttestationVerified===true,
    continuousEvaluationVerified:input.continuousEvaluationVerified===true,
    releaseBlockerEngineVerified:input.releaseBlockerEngineVerified===true,
    mcpExternalConformanceVerifiedIfEnabled:optional(input.mcpEnabled,input.mcpExternalConformanceVerified),
    a2aExternalTckVerifiedIfEnabled:optional(input.a2aEnabled,input.a2aExternalTckVerified),
    remoteAgentTrustVerifiedIfEnabled:optional(input.remoteAgentsEnabled,input.remoteAgentTrustVerified),
    realWorldPhysicalExecutionVerifiedIfEnabled:optional(input.physicalExecutionEnabled,input.realWorldPhysicalExecutionVerified),
  ...
  const manifest=Object.freeze({
    ...
    truthBoundary:Object.freeze({
      ...
      fullProductCognitiveCoverageRequired:true,
      constitutionalExecutionAuthorizationRequired:true,
      constitutionalRedTeamEvidenceRequired:true,
      assuranceControlPlaneRequired:true,
      freshNonContradictoryEvidenceRequired:true,
      supplyChainAttestationRequired:true,
      criticalRiskMustBeClosed:true,
      continuousEvaluationRequired:true,
      releaseBlockersMustBeClosed:true,
      enabledProtocolsRequireExternalConformance:true,
      enabledRemoteAgentsRequireVerifiedScopedTrust:true,
      enabledPhysicalExecutionRequiresLiveBoundaryEvidence:true,
