...
import {LANERIQ_KNOWLEDGE_CONTROL_PLANE_CONTRACT,LANERIQ_KNOWLEDGE_CONTROL_PLANE_INSTRUCTION,getKnowledgeControlPlane} from "./laneriq-knowledge-control-plane.js";

export const LANERIQ_OPERATING_INTELLIGENCE_CONTRACT="laneriq-operating-intelligence-v2";
...
export function getLaneriqOperatingIntelligence(){
  return{
    ...
    systems:{
      ...
      knowledgeControlPlane:LANERIQ_KNOWLEDGE_CONTROL_PLANE_CONTRACT,
    },
    knowledgeControlPlane:getKnowledgeControlPlane(),
    invariants:[
      ...
      "immutable-knowledge-lineage","dependency-impact-before-activation","shadow-canary-before-active",
      "privacy-safe-decision-journal","known-good-rollback-preserves-history"
    ]
  };
}

export const LANERIQ_OPERATING_INTELLIGENCE_INSTRUCTION=`
LANERIQ OPERATING INTELLIGENCE is mandatory for execution planning, governance and recovery.
...
${LANERIQ_KNOWLEDGE_CONTROL_PLANE_INSTRUCTION}
OPERATING RULE: decide before executing, prove before claiming, budget before spending, validate before side effects, preserve knowledge lineage, canary before activation, and recover through bounded reversible controls with known-good rollback.
`;
