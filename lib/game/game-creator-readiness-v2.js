...
export function evaluateGameCreatorReadiness({internalEvidence={},productionEvidence={}}={}){
  ...
  return{
    ...
    truthRule:"A 100 internal Game Creator score proves the implemented creation/runtime/platform/content-production/studio-intelligence/autonomous-development/universal-capability/repository-aware contracts, including MOBA authoritative combat, reconnect/resync, anti-cheat, measured-evidence gates and Combat Integrity V3 server-owned skillshot/AOE/CC/structure validation contracts, only. Production 100 additionally requires verified live networking/matchmaking/load/failover, signed native builds, measured iOS/Android devices, live commerce/ads/telemetry/UGC infrastructure and store-release evidence."
  };
}
