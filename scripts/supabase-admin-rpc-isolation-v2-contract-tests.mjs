...
console.log("✓ Future postgres-created public functions are explicit-grant-only");
console.log("✓ supabase_admin owner-default hardening remains a guarded elevated-role follow-up, not a false closure claim");
