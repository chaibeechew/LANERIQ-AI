...
assert.match(compileMobaHeroGameIdea(hero),/private owner-scoped avatar asset/)
assert.equal(compileMobaHeroToRuntimeSpec(hero).game.moba.abilities.length,4)
...
console.log('✓ MOBA Creator Productization passed: real Provider qualification runner, private Avatar Hero Forge, AI Game handoff and deterministic 100/1K/10K balance simulation are integrated without promoting simulation to live evidence.')
