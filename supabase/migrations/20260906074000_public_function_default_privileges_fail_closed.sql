...
-- This affects only functions created later by the postgres or supabase_admin roles in public.
...
'LANERIQ AI exposed schema. Future postgres- or supabase_admin-created functions default to no API EXECUTE; each RPC must grant only the minimum required role explicitly.';
