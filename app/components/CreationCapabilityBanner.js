...
const CREATIVE=[
  ...
  {href:"/game-builder",title:"Game Builder",note:"Professional playable-game runtime"},
  {href:"/super-game-builder",title:"Super Game Builder",note:"World + Avatar + Combat Forge"},
...
export default function CreationCapabilityBanner(){
  ...
  return <section className="creationExpansion" aria-label={`${PRODUCT_BRAND.name} creation capabilities`}>
    <div className="inner">
      ...
      <p className="platformNote">Idea → World → Character → Combat → Merge → Playable Game. The App + Website builder keeps its existing generation contract; Game and World use their dedicated safe routes.</p>
      ...
      <div className="gameCallout"><span><strong>LANERIQ AI Super Game Creator</strong><small>AI Map + Avatar + Game Intelligence Forge + existing Professional Game Creator.</small></span><Link href="/super-game-builder">Build Super Game ›</Link></div>
    </div>
