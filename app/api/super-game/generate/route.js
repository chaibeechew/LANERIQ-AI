...
export async function POST(request){
  try{
    ...
    const payload=buildSuperGameFusionRequestV2({requestId:body.requestId,idea:body.idea,worldManifest:world.manifest,avatarSelections:selections,genre:body.genre,playMode:body.playMode,forgeBlueprints,settings:body.settings});
