  ...
  try {
    ...
    try {
      ...
      if (isControlTowerStorageMissing(error)) {
        return json({ storageReady: false, technicalCeiling: null, capabilities: auth.capabilities }, 503);
      }
      throw error;
    }
    ...
    return json({ error: "Unable to evaluate technical-ceiling readiness." }, 500);
  }
}
